...
CV disponible [aquí](cv/CV_Matias_Vicuna_Cofre.pdf)
...
- **Data Science Laboratory LABFENUAH (2022-Present)**:
  The Data Science Laboratory of the Faculty of Economics and Business of the Alberto Hurtado University (LABFENUAH) aims to bring the university, academic and research community closer to the use of free, fast and secure access data. My position in this project was as a lab assistant, in charge of collecting, cleaning and consolidating open access financial data from the Financial Market Commission (CMF) from its portal, concretizing hundreds of thousands of financial data from the main companies in the country (Chile) in a large consolidated base. For this task, I have used the R programming language, with which I have been able to perform the corresponding collection, filtering and adaptation of the data, so that they are understandable to anyone who wants to access them.

  In addition to this, I have created a basic Shiny application, with which you can access the data already consolidated and reviewed previously, with which with a few simple clicks, you can access the databases with filters or queries you need,

  To access the Shiny database application, **[click here](https://labfenuah.shinyapps.io/index/)**.

  To view our LABFENUAH website, **[click here](https://www.labfenuah.cl/)**.

  **Note: This project is in development phase, so possible errors in the base and application are to be reviewed, any questions and / or suggestions let me know by email.**
...
- **Laboratorio de Ciencias de Datos LABFENUAH (2022-Presente)**:
  El Laboratorio de Ciencia de Datos de la Facultad de Economía y Negocios de la Universidad Alberto Hurtado (LABFENUAH) tiene como objetivo acercar a la comunidad universitaria, académica y de investigación al uso de datos de acceso libre, rápido y seguro. Mi cargo en este proyecto fue como ayudante de laboratorio, a cargo de la recolección, limpieza y consolidación de datos financieros de acceso abierto de la Comisión para el Mercado Financiero (CMF) desde su portal, concretando cientos de miles de datos financieros de las principales empresas del país (Chile) en una gran base consolidada. Para esta tarea, he utilizado el lenguaje de programación R, con el cual he podido realizar la correspondiente recopilación, filtrado y adaptación de los datos, de manera que sean comprensibles para cualquier persona que quiera acceder a ellos.

  Además de ello, he creado una aplicación Shiny básica, con la cuál se puede acceder a los datos ya consolidados y revisados previamente, con la cuál con unos simples clics, podrán acceder a las bases de datos con los filtros o consultas que necesiten,

  Para acceder a la aplicación Shiny de la base de datos, haz **[clic aquí](https://labfenuah.shinyapps.io/index/)**.

  Para ver nuestro sitio web de LABFENUAH, haz **[clic aquí](https://www.labfenuah.cl/)**.

  **Nota: Este proyecto se encuentra en fase de desarrollo, por lo que posibles errores en la base y aplicación estan por revisar, cualquier consulta y/o sugerencia haganmela saber por correo electrónico.**
